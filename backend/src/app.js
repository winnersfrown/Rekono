...
import openingBalanceImportRoutes from "./routes/openingBalanceImport.js";
...
import boardReportRoutes from "./routes/boardReport.js";
...
app.use(openingBalanceImportRoutes);
...
app.use(prepaidExpensesRoutes);
app.use(adjustmentsRoutes);
app.use(fixedAssetsRoutes);
app.use(writtenChecksRoutes);
app.use(equityRoutes);
app.use(shareRegisterRoutes);
app.use(convertibleInstrumentsRoutes);

...
async function extractWithLlm(ocrText) {
  ...
  const response = await client.models.generateContent({
    ...
    config: {
      ...
      tools: [{ functionDeclarations: [VENDOR_DOC_TOOL] }],
      toolConfig: { functionCallingConfig: { mode: FunctionCallingConfigMode.ANY, allowedFunctionNames: ["record_vendor_document"] } },
    },
  });
